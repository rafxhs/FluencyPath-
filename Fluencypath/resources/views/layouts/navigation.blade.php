        ...
        <div class="flex justify-between h-[80px]">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                            <a href="{{ route('/') }}">
                            <img src="{{URL::asset('images/logo-primaria-horizontal.svg')}}" alt="Logo" class="h-8 w-auto object-contain">
                            </a>
                        </div>
                ...
                <form class="w-[350px]">
                    <div class="relative flex items-center  text-neutral-500 focus-within:text-neutral-800">
                        <input id="searchbar" name="searchbar" type="search" aria-label="Pesquisar"
                            ...
                            class="w-full h-[40px] bg-primary-300 ring-neutral-400 text-neutral-200 border border-solid border-neutral-200 box-border transition-colors cursor-pointer active:enabled:border-neutral-300  duration-300 rounded-lg  focus-visible:ring-neutral-400 shadow-none focus-visible:ring-0 pl-10 ps-8">
                    </div>
                </form>
            </div>

            <div class="flex justify-between items-center space-x-8 sm:-my-px sm:ms-10 sm:flex">
                <button class="w-[90px] h-[40px] relative flex items-center px-3 gap-2 rounded border border-solid border-neutral-200 box-border transition-colors cursor-pointer hover:enabled:border-neutral-300  duration-300">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="1.6em" height="1.6em" viewBox="0 0 32 32">
                            <g fill="none">
                                ...
                                <defs>
                                    ...
                                    <filter id="f517idf" width="14.525" height="18.91" x="9.49" y="11.085" color-interpolation-filters="sRGB" filterUnits="userSpaceOnUse">
                                    ...
                                    <filter id="f517idg" width="11.424" height="22.115" x="5.723" y="2.327" color-interpolation-filters="sRGB" filterUnits="userSpaceOnUse">
                                        <feFlood flood-opacity="0" result="BackgroundImageFix" />
                                        <feBlend in="SourceGraphic" in2="BackgroundImageFix" result="shape" />
                                        <feGaussianBlur result="effect1_foregroundBlur_18_15821" stdDeviation=".625" />
                                    </filter>
                                    <filter id="f517idh" width="6.868" height="14.084" x="4.492" y="6.374" color-interpolation-filters="sRGB" filterUnits="userSpaceOnUse">
                                        <feFlood flood-opacity="0" result="BackgroundImageFix" />
                                        <feBlend in="SourceGraphic" in2="BackgroundImageFix" result="shape" />
