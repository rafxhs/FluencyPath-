...
<section>
    ...
    <div class="flex justify-between">
        <div class="main-wrapper relative">
            ...
            <button class="w-[130px] h-[40px] group relative flex items-center justify-between bg-primary-200 font-primary text-neutral-500 shadow-md rounded-md px-4">
                <span>Textos</span>
                <x-heroicon-s-chevron-down class="w-6 h-6 text-neutral-500" />
            </button>
            <ul class="w-full dropdown-menu absolute text-neutral-500 pt-1 shadow-md">
                <li>
                    <a href="#" class="bg-primary-200 whitespace-no-wrap roundend-md">Textos</a>
                </li>
                <li>
                    <a href="#" class="bg-primary-200 whitespace-no-wrap roundend-md">Flashcards</a>
                </li>
                <li>
                    <a href="#" class="bg-primary-200 whitespace-no-wrap roundend-md">Meus textos</a>
                </li>
                <li>
                    <a href="#" class="bg-primary-200 whitespace-no-wrap roundend-md">Meus favoritos</a>
                </li>
            </ul>
    </div>
